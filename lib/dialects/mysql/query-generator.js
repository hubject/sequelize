...
var QueryGenerator = {
  ...
  addQuerySessionVariables: function (sql, variables) {
    ...
    var sessionVariableDeclarations = '';
    var unsetSessionVariables = '';

    keys.forEach(function (key) {
      var trimmedKey = key.trim();
      sessionVariableDeclarations += 'SET @' + trimmedKey + ' = ' + self.escape(variables[key]) + ';';
      unsetSessionVariables += 'SET @' + trimmedKey + '= NULL;';
    })

    return sessionVariableDeclarations + ' ' + sql + ' ' + unsetSessionVariables;
  },

  removeSessionVariableResults: function (data, variables) {

    var sessionVariableCount = Object.keys(variables).length;

    return data[sessionVariableCount];
  }
};
